...
# =============================== PER-FORK CONFIG ===============================
# Fleet tag: bagC
BASE_SEED = 2            # BagMLP derives member seeds = BASE_SEED*100 + i + 1
HIDDEN_SIZES = (384, 192, 96)      # MLP hidden-layer widths (per member)
DROPOUT = 0.35             # dropout between hidden layers
...
def main():
    print(
        "[config] fleet=bagC arch=%s dropout=%s base_seed=%d n_members=%d"
